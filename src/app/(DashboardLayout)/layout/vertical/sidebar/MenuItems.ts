...
const Menuitems: MenuitemsType[] = [
  ...
  },
  {
    ...
    children: [
      ...
      //   title: "Details",
      //   icon: IconPoint,
      //   href: "/apps/industry/detail/PineappleInc",
      // },
      {
        id: uniqueId(),
        title: "Create",
      ...
      //   title: "Edit",
      //   icon: IconPoint,
      //   href: "/apps/industry/edit/PineappleInc",
      // },
    ],
  },
  {
    ...
    children: [
      ...
      //   title: "Details",
      //   icon: IconPoint,
      //   href: "/apps/sector/detail/PineappleInc",
      // },
      {
        id: uniqueId(),
        title: "Create",
      ...
      //   title: "Edit",
      //   icon: IconPoint,
      //   href: "/apps/sector/edit/PineappleInc",
      // },
    ],
  },
  // {
  ...
  //       title: "Details",
  //       icon: IconPoint,
  //       href: "/apps/gender/detail/PineappleInc",
  //     },
  //     {
  //       id: uniqueId(),
  //       title: "Create",
  ...
  //       title: "Edit",
  //       icon: IconPoint,
  //       href: "/apps/gender/edit/PineappleInc",
  //     },
  //   ],
  // },
  {
    ...
    children: [
      ...
      //   title: "Details",
      //   icon: IconPoint,
      //   href: "/apps/dhrps/detail/PineappleInc",
      // },
      {
        id: uniqueId(),
        title: "Create",
      ...
      //   title: "Edit",
      //   icon: IconPoint,
      //   href: "/apps/dhrps/edit/PineappleInc",
      // },
    ],
  },
  {
