...
const FaqComponent: React.FC<FaqComponentProps> = ({ faqs, onFaqChange, validationErrors, id }) => {
    ...
    <div id={id}>
      ...
      <Paper elevation={3} sx={{ padding: 2, borderRadius: "8px", mt: 3 }}>
        ...
        {validationErrors?.["company.faq"] && (
          ...
          >
            <ErrorMessage error={{ message: validationErrors["company.faq"] }} />
          </Box>
        )}
      </Paper>
    </div>
